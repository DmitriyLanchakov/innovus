...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('plugins_personslist_categories', (
            ...
            ('category', models.ForeignKey(orm['history.category'], null=False))
        ))
        ...
        db.create_table('cmsplugin_personsincategory', (
            ...
            ('per_page', self.gf('django.db.models.fields.IntegerField')(default=4)),
            ('template', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lists', to=orm['history.Category'])),
        ))
        ...
        db.create_table('cmsplugin_personsonindex', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('speakers', self.gf('django.db.models.fields.related.ForeignKey')(related_name='speakers', to=orm['history.Category'])),
            ('speakers_count', self.gf('django.db.models.fields.IntegerField')(default=3)),
            ('interviews', self.gf('django.db.models.fields.related.ForeignKey')(related_name='interviews', to=orm['history.Category'])),
    ...
    models = {
        ...
        'plugins.personsincategory': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lists'", 'to': "orm['history.Category']"}),
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'plugins.personslist': {
            ...
            'block_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'persons_plugin_categories'", 'symmetrical': 'False', 'to': "orm['history.Category']"}),
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'per_page': ('django.db.models.fields.IntegerField', [], {'default': '4'}),
            'template': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'plugins.personsonindex': {
            ...
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'interviews': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'interviews'", 'to': "orm['history.Category']"}),
            'interviews_count': ('django.db.models.fields.IntegerField', [], {'default': '4'}),
            'speakers': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'speakers'", 'to': "orm['history.Category']"}),
