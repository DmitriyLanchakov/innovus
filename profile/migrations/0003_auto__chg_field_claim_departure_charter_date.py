...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Claim.departure_charter_date'
        db.alter_column('profile_claim', 'departure_charter_date', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Claim.departure_charter_date'
        db.alter_column('profile_claim', 'departure_charter_date', self.gf('django.db.models.fields.DateField')(null=True))
