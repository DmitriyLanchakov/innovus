...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field events on 'Claim'
        db.create_table('profile_claim_events', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('claim', models.ForeignKey(orm['profile.claim'], null=False)),
            ('forumevent', models.ForeignKey(orm['events.forumevent'], null=False))
        ))
        db.create_unique('profile_claim_events', ['claim_id', 'forumevent_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field events on 'Claim'
        db.delete_table('profile_claim_events')
    ...
    models = {
        ...
        'profile.claim': {
            ...
            'events': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['events.ForumEvent']", 'symmetrical': 'False'}),
