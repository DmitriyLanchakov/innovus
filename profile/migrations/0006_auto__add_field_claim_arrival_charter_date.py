...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Claim.arrival_charter_date'
        db.add_column('profile_claim', 'arrival_charter_date', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Claim.arrival_charter_date'
        db.delete_column('profile_claim', 'arrival_charter_date')
    ...
    models = {
        ...
        'profile.claim': {
            ...
            'arrival_charter_date': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'departure_charter_date': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'events': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'registered'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['events.ForumEvent']"}),
            ...
            'programm_type': ('django.db.models.fields.CharField', [], {'default': "'general'", 'max_length': '256'}),
