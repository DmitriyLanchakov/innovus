...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Claim.departure_charter_date'
        db.add_column('profile_claim', 'departure_charter_date', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Claim.departure_charter_date'
        db.delete_column('profile_claim', 'departure_charter_date')
    ...
    models = {
        ...
        'profile.claim': {
            ...
            'departure_charter_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
