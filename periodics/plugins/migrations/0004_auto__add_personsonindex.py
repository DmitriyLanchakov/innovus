...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_personsonindex', (
            ...
            ('speakers', self.gf('django.db.models.fields.related.ForeignKey')(related_name='speakers', to=orm['persons.Category'])),
            ('speakers_count', self.gf('django.db.models.fields.IntegerField')(default=3)),
            ('interviews', self.gf('django.db.models.fields.related.ForeignKey')(related_name='interviews', to=orm['persons.Category'])),
    ...
    models = {
        ...
        'plugins.personsonindex': {
            ...
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'interviews': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'interviews'", 'to': "orm['persons.Category']"}),
            'interviews_count': ('django.db.models.fields.IntegerField', [], {'default': '4'}),
            'speakers': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'speakers'", 'to': "orm['persons.Category']"}),
