...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('plugins', ['Persons'])

        # Adding M2M table for field categories on 'Persons'
        db.create_table('plugins_persons_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('persons', models.ForeignKey(orm['plugins.persons'], null=False)),
            ('category', models.ForeignKey(orm['persons.category'], null=False))
        ))
        db.create_unique('plugins_persons_categories', ['persons_id', 'category_id'])
        ...
        db.send_create_signal('plugins', ['PersonList'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('plugins_persons_categories')
