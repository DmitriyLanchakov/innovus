...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('library_category', 'template', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Category.template'
        db.delete_column('library_category', 'template')
    ...
    models = {
        ...
        'library.resource': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 25, 15, 33, 58, 377047)'}),
