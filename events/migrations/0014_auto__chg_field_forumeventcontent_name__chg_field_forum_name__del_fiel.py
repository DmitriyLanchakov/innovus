...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ForumEvent.language'
        db.delete_column('events_forumevent', 'language')
        ...
        # Deleting field 'ForumEvent.name'
        db.delete_column('events_forumevent', 'name')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ForumEvent.language'
        db.add_column('events_forumevent', 'language', self.gf('django.db.models.fields.CharField')(default='ru', max_length=5), keep_default=False)
        ...
        db.add_column('events_forumevent', 'moderators', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_moderators', null=True, to=orm['library.Category'], blank=True), keep_default=False)
        ...
        # Adding field 'ForumEvent.name'
        db.add_column('events_forumevent', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
