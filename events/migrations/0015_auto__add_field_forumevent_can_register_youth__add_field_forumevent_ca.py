...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ForumEvent.can_register_youth'
        db.add_column('events_forumevent', 'can_register_youth', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ForumEvent.can_register_business'
        db.add_column('events_forumevent', 'can_register_business', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ForumEvent.can_register_youth'
        db.delete_column('events_forumevent', 'can_register_youth')

        # Deleting field 'ForumEvent.can_register_business'
        db.delete_column('events_forumevent', 'can_register_business')
