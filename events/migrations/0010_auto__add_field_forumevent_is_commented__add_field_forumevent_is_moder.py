...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ForumEvent.is_commented'
        db.add_column('events_forumevent', 'is_commented', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'ForumEvent.is_moderated'
        db.add_column('events_forumevent', 'is_moderated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'ForumEvent.moderators'
        db.alter_column('events_forumevent', 'moderators_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['library.Category']))


    def backwards(self, orm):
        
        # Deleting field 'ForumEvent.is_commented'
        db.delete_column('events_forumevent', 'is_commented')

        # Deleting field 'ForumEvent.is_moderated'
        db.delete_column('events_forumevent', 'is_moderated')

        # Changing field 'ForumEvent.moderators'
        db.alter_column('events_forumevent', 'moderators_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['persons.Category']))
