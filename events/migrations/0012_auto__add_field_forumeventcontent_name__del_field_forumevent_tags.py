...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ForumEventContent.name'
        db.add_column('events_forumeventcontent', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Deleting field 'ForumEvent.tags'
        db.delete_column('events_forumevent', 'tags')


    def backwards(self, orm):
        
        # Deleting field 'ForumEventContent.name'
        db.delete_column('events_forumeventcontent', 'name')

        # Adding field 'ForumEvent.tags'
        db.add_column('events_forumevent', 'tags', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
