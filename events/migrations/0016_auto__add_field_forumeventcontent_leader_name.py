...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ForumEventContent.leader_name'
        db.add_column('events_forumeventcontent', 'leader_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ForumEventContent.leader_name'
        db.delete_column('events_forumeventcontent', 'leader_name')
