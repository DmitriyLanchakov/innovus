...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ForumEvent.videostream'
        db.add_column('events_forumevent', 'videostream', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ForumEvent.videostream'
        db.delete_column('events_forumevent', 'videostream')
