...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ForumEventContent'
        db.create_table('events_forumeventcontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('language', self.gf('django.db.models.fields.CharField')(default='ru', max_length=5)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.ForumEvent'])),
            ('place', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
            ('moderators', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='forum_events', null=True, to=orm['library.Category'])),
            ('cms_page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, blank=True)),
        ))
        db.send_create_signal('events', ['ForumEventContent'])


    def backwards(self, orm):
        
        # Deleting model 'ForumEventContent'
        db.delete_table('events_forumeventcontent')
