...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PersonsInCategory.sorting'
        db.add_column('cmsplugin_personsincategory', 'sorting', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)

        # Adding field 'PersonsList.sorting'
        db.add_column('cmsplugin_personslist', 'sorting', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)

        # Adding field 'PersonsOnIndex.sorting'
        db.add_column('cmsplugin_personsonindex', 'sorting', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PersonsInCategory.sorting'
        db.delete_column('cmsplugin_personsincategory', 'sorting')

        # Deleting field 'PersonsList.sorting'
        db.delete_column('cmsplugin_personslist', 'sorting')

        # Deleting field 'PersonsOnIndex.sorting'
        db.delete_column('cmsplugin_personsonindex', 'sorting')
