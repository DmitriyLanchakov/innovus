...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ForumHistory'
        db.create_table('cmsplugin_forumhistory', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('forum', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Forum'])),
        ))
        db.send_create_signal('plugins', ['ForumHistory'])


    def backwards(self, orm):
        
        # Deleting model 'ForumHistory'
        db.delete_table('cmsplugin_forumhistory')
