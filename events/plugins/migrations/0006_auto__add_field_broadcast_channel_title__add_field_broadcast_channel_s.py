...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Broadcast.channel_title'
        db.add_column('cmsplugin_broadcast', 'channel_title', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)

        # Adding field 'Broadcast.channel_stream'
        db.add_column('cmsplugin_broadcast', 'channel_stream', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)

        # Adding field 'Broadcast.channel_display'
        db.add_column('cmsplugin_broadcast', 'channel_display', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Broadcast.channel_title'
        db.delete_column('cmsplugin_broadcast', 'channel_title')

        # Deleting field 'Broadcast.channel_stream'
        db.delete_column('cmsplugin_broadcast', 'channel_stream')

        # Deleting field 'Broadcast.channel_display'
        db.delete_column('cmsplugin_broadcast', 'channel_display')
    ...
    models = {
        ...
        'plugins.broadcast': {
            ...
            'channel_display': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'channel_stream': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
            'channel_title': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
